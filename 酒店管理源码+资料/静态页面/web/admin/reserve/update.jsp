    ...
    <form class="layui-form" lay-filter="update" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="id_card" name="id_card" value="${info.id_card}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="start_time" value="<fmt:formatDate value="${info.start_time}" pattern="yyyy-MM-dd HH:mm:ss" />" class="layui-input" id="test" placeholder="yyyy-MM-dd HH:mm:ss">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox"  name="status" lay-skin="switch" lay-filter="switchTest" lay-text="入住|预定">
            </div>
        </div>
        <div class="layui-form-item">
            <label  class="layui-form-label">
            ...
            <div class="layui-input-block">
                <textarea name="remarks" rows="5" cols="85">${info.remark}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label  class="layui-form-label">
