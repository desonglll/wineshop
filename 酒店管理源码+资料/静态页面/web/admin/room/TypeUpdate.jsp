...
<div class="x-body">
    ...
    <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea name="remark"  id="remark" class="layui-textarea" placeholder="请输入介绍信息"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label  class="layui-form-label">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        %>
        $.ajax({
            url: "<%=basePath%>roomTypeServlet",
            type: "POST",
            data: {id:<%=id%>,flag:"queryById"},
        ...
        form.on('submit(updateSubmit)', function(data){
            ...
            debugger
            $.ajax({
                url:"<%=basePath%>roomTypeServlet?flag=update",
                type:"post",
                data:data,
                success:function (result) {
                    if(result.code==0){
